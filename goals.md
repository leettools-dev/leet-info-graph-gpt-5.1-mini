---
project_name: leet-info-graph-gpt-5.1-mini
created_at: 2026-02-02T15:26:33.905390+00:00
status: in_progress
---
...
7. Implementation Guide Compliance

Follow instructions in `src/leet_apps/implementation.guide.md`: UI in `src/leet_apps/ui`, 
backend in `src/leet_apps/api`, configs in `src/leet_apps/config.yaml`, tests in `src/leet_apps/tests`.
